...
$select_all_up_comments = mysqli_query($connection, $query);
$up_comments = mysqli_num_rows($select_all_up_comments);
...
?>
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          $element_count = [$published_post_counts, $post_counts, $post_draft_counts, $comments_counts, $up_comments, $users_counts, $subscriber_count,$categories_counts]; 
